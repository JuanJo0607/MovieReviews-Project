...
def home(request):
    ...
    #return render(request, 'home.html', {'name':'Juan José Restrepo Cardona'})
...
def statistics_view(request):
    matplotlib.use('Agg')
    years = Movie.objects.values_list('year', flat=True).distinct().order_by('year') # Obtener todos los años delas películas
    ...
    # NUEVA GRÁFICA: Películas por género (primer género)
    ...
    plt.figure()  # IMPORTANTE para no mezclar gráficas
